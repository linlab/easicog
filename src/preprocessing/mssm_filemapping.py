...
def create_nu_associations_dataframe(groundtruth_df, language_df, features_dir, output_csv):
    ...
    df = df[df['tkdname']!='Miss.wav']
    # language_df = language_df[language_df['tkdname']!='Miss.wav']
    ...
    for filename in files_list:
        subject_pattern = os.path.basename(filename)[8:-9]  # Assuming filename format is consistent
        matching_row = merged_df[merged_df['tkdname'].str.contains(subject_pattern, regex=False)]
...
if __name__ == "__main__":
    ...
    # for dataset in [config["datasets"][1]]:
        ...
        # except:
        #     print('No hubert features found')
        ...
        #         groundtruth_df = dataset['groundtruth_csv'], 
        #         language_df = os.path.join(dataset['transcription_outdir'],dataset['language_csv_name']),
        #         features_dir = dataset['jina_embedding_outdir'], 
        #         output_csv = dataset['jina_df'])
        # except:
        #     print('No Jina Sentence features found')
        ...
        try:
            mapping_function(
                ...
                # features_dir = "/sc/arion/projects/EASI-COG/jt_workspace/taukadial-2024/src/data/processed/mssm_testset_whisper_embedding",
        ...
        try:
            mapping_function(
                ...
                # features_dir = "/sc/arion/projects/EASI-COG/jt_workspace/taukadial-2024/src/data/processed/mssm_testset_promaps_embedding",
        ...
        #         groundtruth_df = dataset['groundtruth_csv'], 
        #         language_df = os.path.join(dataset['transcription_outdir'],dataset['language_csv_name']),
        #         features_dir = dataset['whisper_chunk_outdir'], 
        #         output_csv = dataset['whisper_chunk_df'])
        # except:
        #     print('No whisper chunks found')
